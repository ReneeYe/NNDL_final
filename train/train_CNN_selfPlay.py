...
from RL_QG_agents.CNN_DQN import DQNAgent
...
model_dir = "../models_saver/models_CNN_DQNself/"
...
for i_episode in range(n, MAX_EPOCHS + 1):
    ...
    for t in range(66):
        ...
        if len(enables) == 0:
            ...
            agent_black.store_experience(obs_black.T, [], action_, reward_tmp * 100, observation_tmp.T,
            ...
            for tries in enables:
                ...
                agent_black.store_experience(obs_black.T, enables, tries, reward_tmp * 100, observation_tmp.T,
                                             tmp.possible_actions, done_tmp)
        ...
        if len(enables) == 0:
            ...
            agent_white.store_experience(obs_white.T, [], action_, reward_tmp * 100, observation_tmp.T,
                                         tmp.possible_actions, done_tmp)
        else:
            for tries in enables:
                tmp = copy.deepcopy(env)
                observation_tmp, reward_tmp, done_tmp, info_tmp = tmp.step([tries, 1])
                agent_white.store_experience(obs_white.T, enables, tries, reward_tmp * 100, observation_tmp.T,
                                             tmp.possible_actions, done_tmp)
