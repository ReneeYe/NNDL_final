# -*- coding: utf-8 -*-
"""
Created on Wed Jan 17 14:36:07 2018
...
import RL_QG_agents.greedy as greedy
...
model_dir = "../models_saver/models_DQNvsGreedy/"
...
for i_episode in range(n, MAX_EPOCHS + 1):
    ...
    for t in range(66):
        ...
        if len(enables) == 0:
            ...
            player = 1
            action_  = agent_white.place(observation, enables,player)
        action_w[0] = action_
